package com.pj.project.sp_dev.uploadfile;
...
public class UploadConfig {
	...
	public String videoSuffix = "mp4,avi,rmvb,mov,flv,mkv";						// 视频允许的后缀
	...
	public String fileSuffix = "jpg,exe,txt,zip,json,xml";						// file允许的后缀 (为防止上传恶意文件，这里必须手动指定可上传的类型)

	public long maxSize = 1024 * 1024 * 1024 * 2l;	// 文件最大大小,单位/B , 此为2G
