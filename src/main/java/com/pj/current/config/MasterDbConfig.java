...
public class MasterDbConfig {
    ...
    static final String PACKAGE = "com.pj.project.sp_dev";
    private static final String MAPPER_LOCATION = "classpath*:mapper/sp-dev/*.xml";
    private static final String DOMAIN_PACKAGE = "com.pj.project.sp_dev";
